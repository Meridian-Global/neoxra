...
const ZONE_PRESETS = {
  'hogan-green': {
    ...
    nameZh: 'Hogan 綠色模板',
    titleZone: {
      y_start: 45, y_end: 165, x_left: 70, x_right: 70,
      font_size: 42, font_weight: 900, color: '#FFFFFF',
      emphasis_color: '#FFD700', text_align: 'center', line_height: 1.2,
    },
    contentZone: {
      y_start: 175, y_end: 935, x_left: 90, x_right: 90,
      font_size: 34, font_weight: 700, color: '#FFFFFF',
      emphasis_color: '#FFD700', text_align: 'center', line_height: 1.65,
    },
    watermark: '@hogan.tech',
    watermarkX: 820,
    watermarkY: 1045,
  ...
  'center-full': {
    ...
    contentZone: {
      y_start: 180, y_end: 960, x_left: 80, x_right: 80,
