...
const ZONE_PRESETS = {
  'hogan-green': {
    ...
    nameZh: 'Hogan 綠色模板',
    titleZone: {
      y_start: 55, y_end: 155, x_left: 80, x_right: 80,
      font_size: 52, font_weight: 900, color: '#FFFFFF',
      emphasis_color: '#FFD700', text_align: 'center', line_height: 1.3,
    },
    contentZone: {
      y_start: 210, y_end: 810, x_left: 100, x_right: 100,
      font_size: 42, font_weight: 700, color: '#FFFFFF',
